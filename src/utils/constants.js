...
const data = {
  ...
  inactiveButtonClass: "popup__btn-save_disabled", // неактивная кнопка сохранить/добавить
  inputErrorClass: "popup__text_type_error", //красное подчеркивание
  errorClass: "popup__input-error", // красное оформление
};
// атрибуты API
const options = {
